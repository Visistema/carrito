...
public class JframeAuto extends javax.swing.JFrame {
     ...
     */
    public JframeAuto() {
        initComponents();//cuando creamos objetos de la libreria Swing el contructor inicializa los componentes 
    }
    ...
    private void initComponents() {
        ...
        lbl1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/carreraautos/1.jpg"))); // NOI18N
        lbl1.setMaximumSize(new java.awt.Dimension(93, 34));
        lbl1.setMinimumSize(new java.awt.Dimension(93, 34));
        lbl1.setPreferredSize(new java.awt.Dimension(164, 59));

        lbl2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/carreraautos/1.jpg"))); // NOI18N

        lbl_barrera.setText("META");
        lbl_barrera.setAlignmentY(0.0F);
        lbl_barrera.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 51), 10));
        lbl_barrera.setVerticalTextPosition(javax.swing.SwingConstants.TOP);

        lbl3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/carreraautos/1.jpg"))); // NOI18N
    ...
    private void btiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btiniciarActionPerformed
        lbl1.setLocation(0,lbl1.getLocation().y);//colocamos las etiquetas en una posición 0 sobre el eje X y obtenemos la posición actual del eje y (Donde estan actualmente las etiquetas).
        lbl2.setLocation(0,lbl2.getLocation().y);
        lbl3.setLocation(0,lbl3.getLocation().y);
        Carrera hilo1=new Carrera(lbl1, this);//Creamos los hilos
        Carrera hilo2=new Carrera(lbl2, this);
        Carrera hilo3=new Carrera(lbl3, this);
        hilo1.start();//Inicializamos los Hilos
        hilo2.start();
        hilo3.start();
